...
public class AlsaCardInfo
{
    ...
    private readonly List<AlsaPcmEntry> _pcmEntries;

    /// <summary>Initializes a new instance of <see cref="AlsaCardInfo"/>.</summary>
    public AlsaCardInfo(int index, string id, string name, string longName, string driver, string mixerName, string components)
    {
        ...
        _pcmEntries = new List<AlsaPcmEntry>();
    }
    ...
    public List<AlsaPcmEntry> PcmEntries => _pcmEntries;
