...
public class AlsaPcmEntry
{
    ...
    private readonly List<AlsaSubdevice> _subdevices;
    ...
    /// <summary>Initializes a new instance of <see cref="AlsaPcmEntry"/>.</summary>
    ...
    public List<AlsaSubdevice> Subdevices => _subdevices;
